...
```hcl
# Azure Subscription ID (find it in Azure Portal > Subscriptions)
...
apim_sku  = "Developer_1"  # Use StandardV2_1 for production

# Foundry Projects — one per team (simple string list)
